...
class RotatingFileHandler(BaseRotatingHandler):
    ...
    def doRollover(self):
        ...
        if self.backup_count > 0:
            ...
            if os.path.exists(dfn):
                os.remove(dfn)
            # Issue 18940: A file may not have been created if timer is True.
    ...
    def shouldRollover(self, record):
        ...
        if self.stream is None:  # timer was set...
            self.stream = self._open()
...
STOP_LOGS = [
    ...
    "urllib3.connection",
    "elasticsearch.trace",
    "requests.packages.urllib3.pub",
    "requests.packages.urllib3.pub.retry",
    "urllib3.pub",
