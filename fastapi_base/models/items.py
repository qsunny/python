...
class Anchor(Items):
    uid = fields.CharField(max_length=20, unique=True, description="UID")
    nickname = fields.CharField(max_length=30, null=True, description="博主昵称")
...
#
#     def __repr__(self):
#         return "<{}: {}>".format(self.item_name, json.dumps(self.to_dict))
#
