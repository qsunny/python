...
# from fastapi_base.env.debug import Setting
...
#         if ip_ports is None:
#             ip_ports = setting.REDIS_IP_PORTS
#         if db is None:
#             db = setting.REDIS_DB
#         if user_pass is None:
#             user_pass = setting.REDIS_USER_PASS
#         if service_name is None:
#             service_name = setting.REDIS_SERVICE_NAME
#
