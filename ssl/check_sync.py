...
def renew_cert(ali_key="", ali_secret=""):
    ...
    renew_result = subprocess.check_output(["/home/aaron/.acme.sh/acme.sh", "--renew", "--dns", "dns_ali", "-d", "yunlang.net.cn", "-d", "*.yunlang.net.cn", "--force", "--accountconf", "/home/aaron/.acme.sh/account.conf"],
                                           env=env_dic)
